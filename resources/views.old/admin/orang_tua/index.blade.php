					...
					<div class="modal-content">
						...
						<div class="modal-body">
                            ...
                            <div class="card card-outline card-primary">
                                ...
                                <div class="card-body">
                                    <ul>
                                        <li>rows 1 = nama Orang Tua</li>
                                        <li>rows 2 = no induk Orang Tua</li>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('orang_tua.destroy', $data->id) }}" method="post">
                                ...
                                <a href="{{ route('orang_tua.edit_anak', Crypt::encrypt($data->id)) }}" class="btn btn-success btn-sm mt-2"><i class="nav-icon fas fa-edit"></i> &nbsp; Edit Anak</a>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="nik" name="nik" onkeypress="return inputAngka(event)" class="form-control @error('no_induk') is-invalid @enderror">
                    </div>
                    <div class="form-group">
