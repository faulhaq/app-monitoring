            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    ...
                    @if (Auth::user()->role == 'guru')
                        ...
                        <a href="{{ asset('uploads/guru/'.$guru->foto) }}" data-toggle="lightbox" data-title="Foto {{ Auth::user()->name() }}" data-gallery="gallery" data-footer='<a href="{{ route('pengaturan.edit-foto') }}" id="linkFotoGuru" class="btn btn-link btn-block btn-light"><i class="nav-icon fas fa-file-upload"></i> &nbsp; Ubah Foto</a>'>
                            <img src="{{ asset('uploads/guru/'.$guru->foto) }}" width="130px" class="profile-user-img img-fluid img-circle" alt="User profile picture">
                        </a>
