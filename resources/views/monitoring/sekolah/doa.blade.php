    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('monitoring.sekolah.doa.store') }}" method="post" enctype="multipart/form-data"> @csrf <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="doa">Doa</label>
                                <input type="text" id="doa" name="doa" onkeypress="return inputAngka(event)" class="form-control @error('doa') is-invalid @enderror" required>
                            </div>
                            <div class="form-group">
