        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('monitoring.keagamaan.tahsin.store', Crypt::encrypt($fsiswa)) }}" method="post"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="tipe_iqro" name="tipe"
                                            value="iqro" required>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="tipe_juz" name="tipe"
                                            value="juz" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="n" name="n"
                                        ...
                                        class="form-control @error('n') is-invalid @enderror" required>
                                </div>
                                <div class="form-group">
                                    <label for="halaman">Halaman</label>
                                    <input type="text" id="halaman" name="halaman"
                                        class="form-control @error('halaman') is-invalid @enderror" required>
                                </div>
                                <div class="form-group">
