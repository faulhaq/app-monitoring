...
@section('heading', 'Edit Pekerjaan')
@section('page')
  <li class="breadcrumb-item active"><a href="{{ route('guru.index') }}">Pekerjaan</a></li>
...
<div class="col-md-12">
    ...
    <div class="card card-primary">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form action="{{ route('data_ref.pekerjaan.update', Crypt::encrypt($pekerjaan->id)) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('patch')
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="id" name="id" value="{{ $pekerjaan->id }}" class="form-control" readonly>
                </div>
                <div class="form-group">
                    <label for="nama">Nama Pekerjaan</label>
                    <input type="text" id="nama" name="nama" value="{{ $pekerjaan->nama }}" class="form-control">
                </div>
            </div>
          </div>
        </div>
