...
@section('heading', 'Data Monitoring Harian Pilihan')
@section('page')
  <li class="breadcrumb-item active">Data Monitoring Harian Pilihan</li>
@endsection
@section('content')
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target=".bd-example-modal-lg">
                    <i class="nav-icon fas fa-folder-plus"></i> &nbsp; Tambah Data Monitoring Harian Pilihan
                </button>
            </h3>
        </div>
        <!-- /.card-header -->
