                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form class="d-flex flex-col"
                                        action="{{ route('user.destroy', $enc_id) }}" method="post">
                                        @csrf
                                        @method('delete')
                                        <a href="{{ route('user.show', $enc_id) }}" class="btn btn-info btn-sm pt-2 mx-2"><i
                                                class="nav-icon fas fa-id-card"></i> &nbsp; Detail</a>
                                        <a href="{{ route('user.edit', $enc_id) }}" class="btn btn-success btn-sm pt-2 mx-2"><i
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="role" name="role"
                                        class="select2bs4 form-control @error('role') is-invalid @enderror" required>
                                ...
                                <div class="form-group" id="list_user_fg" style="display: none">
                                    ...
                                    <select id="list_user" name="id_fk_user"
                                        class="select2bs4 form-control @error('id_fk_user') is-invalid @enderror" required>
                                    </select>
                                </div>
                                ...
                                <div class="form-group" id="password_fg" style="display: none">
                                    ...
                                    <input autocomplete="off" type="text" value="{{ $gen_pass }}" id="password"
