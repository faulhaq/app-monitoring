                        ...
                        @foreach ($siswa as $data)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form class="d-flex flex-col" action="{{ route('siswa.destroy', $enc_id) }}"
                                        method="post">
                                        @csrf
                                        @method('delete')
                                        <a href="{{ route('siswa.show', $enc_id) }}"
                                            class="btn btn-info btn-sm pt-2 mx-2"><i class="nav-icon fas fa-id-card"></i>
                                            &nbsp; Detail</a>
                                        <a href="{{ route('siswa.edit', $enc_id) }}"
                                            class="btn btn-success btn-sm pt-2 mx-2"><i class="nav-icon fas fa-edit"></i>
                                            &nbsp; Edit</a>
                                        <button class="btn btn-danger btn-sm pt-2 mx-2"><i
                                                class="nav-icon fas fa-trash-alt mx-2"></i> &nbsp; Hapus</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="jk" name="jk"
                                        class="select2bs4 form-control @error('jk') is-invalid @enderror" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="agama" name="agama"
                                        class="select2bs4 form-control @error('agama') is-invalid @enderror" required>
                                        <option value="">-- Pilih Agama --</option> <?= FormWithRef::get_agama() ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="nis">Alamat</label>
                                    <input type="text" id="alamt" name="alamat"
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="status" name="status"
                                        class="select2bs4 form-control @error('status') is-invalid @enderror" required>
