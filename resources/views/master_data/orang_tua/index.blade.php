                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-col">
                                        ...
                                        <a href="{{ route('orang_tua.list_orang_tua', $enc_id) }}"
                                            class="btn btn-info btn-sm pt-2 mx-2"><i class="nav-icon fas fa-id-card"></i>
                                            &nbsp;
                                            Detail</a>
                                        @if ($nr_ortu < 2)
                                            <button onclick="$('#no_kk').val('{{ $data->kk()->no_kk }}')" type="button"
                                                class="btn btn-default btn-sm pt-2 mx-2" data-toggle="modal"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="goldar" name="goldar"
                                        class="select2bs4 form-control @error('goldar') is-invalid @enderror" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="telp" name="telp"
                                        onkeypress="return inputAngka(event)"
                                        class="form-control @error('telp') is-invalid @enderror" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="pekerjaan" name="pekerjaan"
                                        class="select2bs4 form-control @error('pekerjaan') is-invalid @enderror" required>
