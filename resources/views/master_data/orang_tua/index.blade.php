    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                ...
                <a href="{{ route('orang_tua.export_excel') }}" class="btn btn-success btn-sm my-3" target="_blank"><i class="nav-icon fas fa-file-export"></i> &nbsp; EXPORT EXCEL</a>
        ...
        <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<form method="post" action="{{ route('orang_tua.import_excel') }}" enctype="multipart/form-data">
					<div class="modal-content">
						...
						<div class="modal-body">
                            ...
                            <div class="card card-outline card-primary">
                                ...
                                <div class="card-body">
                                    <ul>
                                        <li>rows 1 = nama orang_tua</li>
                                        <li>rows 2 = nip orang_tua</li>
                ...
                <tr>
                    ...
                    <td>
                        @if (is_null($data->foto))
                            Tidak ada foto
                        @else
                            <a href="{{ asset('uploads/orang_tua/'.$data->foto) }}" data-toggle="lightbox" data-title="Foto {{ $data->nama }}" data-gallery="gallery" data-footer='<a href="{{ route('orang_tua.ubah_foto', Crypt::encrypt($data->id)) }}" id="linkFotoOrangTua" class="btn btn-link btn-block btn-light"><i class="nav-icon fas fa-file-upload"></i> &nbsp; Ubah Foto</a>'>
